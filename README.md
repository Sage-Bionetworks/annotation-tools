...
**Error Directory**
( `-e | --error-directory` ) : This is the error directory where the failed annotation MAF error reports will be written. This is a sub-directory within the output directory which will hold the failed annotation error reports. This directory will be created if it does not already exist. Any existing files within the error-directory will be deleted when this script is run.
