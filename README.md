...
bash import-scripts/annotation_suite/annotation_suite_wrapper.sh
    ...
    -o | --output-directory              output directory to write processed mutation data files, annotated mutation data files, and failed annotation error reports to
...
**Output Directory** ( `-o | --output-directory` ) : This is the output directory where the processed (standardized) MAFs, annotated MAFs and failed annotation MAF error reports will be written. Sub-directories within the output directory will hold the standardized MAFs, annotated MAFs and failed annotation error reports. These sub-directories will be created if they do not already exist. Any existing files within the output-directory and subdirectories will be deleted when this script is run.
...
See [CONTRIBUTING](CONTRIBUTION.md) for how to make contributions to this repo.
